...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-027.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-029.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot with a=0.2
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-030.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,1): // plot with 0.1
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-031.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-032.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-033.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-034.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-038.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-039.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-044.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-045.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-048.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector of expressions
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-054.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-055.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-057.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-058.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-062.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-063.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-064.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-065.png}
...
>insimg;  
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-066.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-067.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-068.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-069.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-070.png}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-075.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-076.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-077.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-078.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-079.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-080.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-081.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-082.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=red): // add plot of line
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-083.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-084.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-085.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-086.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-087.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-090.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-091.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-092.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-093.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-094.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-095.png}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-096.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-097.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-098.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-099.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-100.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-101.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-102.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-103.png}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-104.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-105.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-106.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-107.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-108.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-109.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-110.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-111.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-112.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-113.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-114.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-115.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-116.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-118.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-119.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-120.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-121.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-124.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-125.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-126.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-127.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-128.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-129.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-130.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-131.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-132.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-133.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-134.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-135.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-136.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-137.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-138.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-139.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-140.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-141.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-142.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-144.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-145.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-147.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-148.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-149.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-150.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-151.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-152.png}
\begin{eulerprompt}
>     
\end{eulerprompt}
\eulersubheading{Contoh soal}
\begin{eulercomment}
1. Buatkan grafik dari fungsi \\
\end{eulercomment}
\begin{eulerformula}
\[
y= -2x^3+3x^2
...
\end{eulerformula}
\begin{eulercomment}
pada [-1/2,2] kemudian tentukan posisi maksimum dan minimum dari
fungsi tersebut!
\end{eulercomment}
\begin{eulerprompt}
>function f(x):= -2*x^3+3*x^2
>plot2d("f",(-1/2),2, title=latex("y=-2x^3+3x^2"),xl="x",yl="y");...
>label("maks",1,f(1),pos="uc"); label("min",2,f(2),pos="uc"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-154.png}
\begin{eulercomment}
Diketahui posisi maksimum dan minimum dari fungsi tersebut. Pada
interval tersebut nilai maksimumnya adalah 1 dan nilai minimumnya
adlaah -4.


2. Tentukan grafik dari fungsi trigonometri\\
\end{eulercomment}
\begin{eulerformula}
\[
y= sin(2x)+cos(x)
...
\end{eulerformula}
\begin{eulerprompt}
>function f(x):= sin(2*x)+cos(x)
>plot2d("f",-1,2, title=latex("y=sin(2x)+cos(x)"),xl="x",yl="y"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-156.png}
\begin{eulercomment}
Berikut grafik dari fungsi trigonometri yang diketahui dengan interval
-1 sampai dengan 2.
...
\end{eulerformula}
\begin{eulercomment}
pada [-2,4] kemudian tentukan titik potongnya!
\end{eulercomment}
\begin{eulerprompt}
>plot2d(["x^2","5*x"],-2,4, title="grafik perpotongan fungsi y=x^2 dan g=5x", xl="x",yl="y", grid=8);...
>label(["P","(0,0)"],0,0); label("5x",2,10,pos="uc"); label("x^2",3,7,pos="lc"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-159.png}
\begin{eulercomment}
Titik potong pada kedua fungsi tersebut berada di titik P(0,0) dengan
interval x dari -2 sampai dengan 4.
...
\end{eulercomment}
\begin{eulerprompt}
>plot2d("exp(x)",1,3, title=latex("y=exp(x)"), xl="x", yl="y", grid=7):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-161.png}
\begin{eulercomment}
Berikut grafik dari fungsi tersebut. Grafiknya menggunakan style yang
bukan default EMT.


5. Gambarkan grafik fungsi berikut \\
\end{eulercomment}
\begin{eulerformula}
\[
y= x^2+5x+4
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("x^2+5*x+4",-1,5, title=latex("x^2+5x+4"), xl="x", yl="y"); label("(1,10)",1,10); label("(4,40)",4,40):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Nabila 'Aqil Mufida_22305141039-163.png}
\begin{eulercomment}
Berikut grafik fungsi y=x\textasciicircum{}2+5x+4 dengan interval -1 sampai 5. Dengan
nilai x=1 diperoleh nilai y=10 dan x=4 nilai y=40, seperti yang
