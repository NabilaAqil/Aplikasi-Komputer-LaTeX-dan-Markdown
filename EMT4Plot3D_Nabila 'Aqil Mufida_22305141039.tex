...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-001.png}
\begin{eulerprompt}
>plot3d("x^2+x*sin(y)",-5,5,0,6*pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-003.png}
\eulerheading{Fungsi dua Variabel}
\begin{eulercomment}
Untuk grafik suatu fungsi, gunakan

- expresi sederhana dalam x dan y,\\
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-004.png}
\begin{eulercomment}
...
- +,-: memperbesar atau memeperkecil\\
- a: menghasilkan anagliph (lihat di bawah)\\
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-007.png}
\begin{eulerprompt}
>plot3d("x^2+y",distance=3,zoom=1,angle=pi/2,height=0):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-009.png}
\begin{eulercomment}
...
agar plot tetap masuk ke dalam jendela plotting, dengan \\
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-011.png}
\begin{eulerprompt}
>plot3d("1/(x^2+y^2+1)",r=5,>polar, ...
>fscale=2,>hue,n=100,zoom=4,>contour,color=gray):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-012.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r);...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=2pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-013.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-014.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-015.png}
\begin{eulerprompt}
>plot3d("x^2+1",a=-1,b=1,rotate=2,grid=5):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-016.png}
\begin{eulerprompt}
>plot3d("sqrt(25-x^2)",a=0,b=5,rotate=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-017.png}
\begin{eulerprompt}
>plot3d("x*sin(x)",a=0,b=6pi,rotate=2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-019.png}
\eulerheading{Plot Kontur}
\begin{eulercomment}
Untuk plotnya, Euler menambahkan garis grid. Sebaliknya dimungkinkan
untuk menggunakan garis datar dan rona satu warna atau\\
rona warna spektral. Euler dapat menggambar ketinggian fungsi pada
plot dengan arsiran. Di semua plot 3D, Euler dapat menghasilkan
anaglyph merah/cyan.
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-020.png}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-023.png}
\begin{eulerprompt}
>plot3d("x^2-y^2",0,5,0,5,level=-1:0.1:1,color=redgreen):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-028.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-029.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-034.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-037.png}
\begin{eulerprompt}
>c=1; d=1;
>plot3d("((x^2+y^2-c^2)^2+(z^2-1)^2)*((y^2+z^2-c^2)^2+(x^2-1)^2)*((z^2+x^2-c^2)^2+(y^2-1)^2)-d",r=2,<frame,>implicit,>user): 
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-038.png}
\begin{euleroutput}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-039.png}
...
nilai s untuk membuat parameter permukaan bola.\\
Dalam gambar kita dapat menandai wilayah, dalam kasus kita wilayah
kutub.
\end{eulercomment}
\begin{eulerprompt}
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-044.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-049.png}
\begin{eulercomment}
Dimungkinkan juga untuk memplot kurva dalam 3D. Dalam hal ini, lebih
mudah untuk menghitung terlebih dahulu titik-titik kurva.\\
Untuk kurva pada bidang kita menggunakan barisan koordinat dan
parameter wire=true.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-050.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-051.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-055.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-056.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-058.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-059.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-060.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-061.png}
\begin{eulerprompt}
...
memplot hati yang diputar sebagai permukaan parametrik.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-067.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-068.png}
\begin{eulercomment}
...
>myplot(x,y,z):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-069.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-070.png}
...
Kamu perlu menginstal Povray (32bit or 64bit) dari
http://www.povray.org/,\\
...
eulerhome(), biasanya c:\textbackslash{}Users\textbackslash{}Username\textbackslash{}Euler.\\
Povray menghasilkan file PNG, yang dapat dimuat oleh Euler ke dalam
notebook. Untuk membersihkan file-file ini, gunakan povclear().
...
raytracer akan dimulai,\\
dan PNG akan dimasukkan ke dalam notebook Euler.
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-071.png}
\begin{eulerprompt}
>pov3d("x^2+y^2",zoom=3);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-073.png}
\begin{eulercomment}
...
>  <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-074.png}
\begin{eulerprompt}
>pov3d("((x-1)^2+y^2)*((x+1)^2+y^2)/40",r=2, ...
>  angle=-120°,level=1/40,dlevel=0.005,light=[-1,1,1],height=10°,n=50, ...
>  <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-075.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-076.png}
\begin{eulerprompt}
...
>  w=500,h=300);
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-077.png}
\begin{eulerprompt}
>function f(x) := x^3-x+1; ...
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-078.png}
\begin{eulercomment}
...
>  w=500,h=300);
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-079.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-080.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-081.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-082.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-083.png}
...
>povend;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-084.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-085.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-086.png}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-088.png}
\begin{eulerprompt}
>povstart(angle=70°,height=50°,zoom=4);
\end{eulerprompt}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-089.png}
...
karena terlalu besar. Jadi kita mendefinisikan objek dalam file\\
Povray menggunakan #declare. Fungsi povtriangle() melakukan ini secara
...
\end{eulerprompt}
\begin{eulercomment}
Tambahkan sumbu dan selesei.
\end{eulercomment}
\begin{eulerprompt}
>writeAxes(0,1,0,1,0,1,d=0.015); ...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-090.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-091.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-092.png}
...
\begin{eulerttcomment}
 pertanyaan lebih lanjut. Anda mungkin harus menekan OK di jendela
\end{eulerttcomment}
\begin{eulercomment}
Povray untuk mengonfirmasi dialog pengaktifan Povray.
\end{eulercomment}
\begin{eulerprompt}
...
>povend(h=320,w=480);
\end{eulerprompt}
\eulerimg{18}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-093.png}
\begin{eulercomment}
...
\end{eulerudf}
\begin{eulercomment}
Sekarang kita dapat memplot adegannya.
\end{eulercomment}
\begin{eulerprompt}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-096.png}
...
\end{eulercomment}
\eulersubheading{}
\eulerheading{Contoh penyelesaian masalah }
\begin{eulercomment}
1. Gambarkan dalam 3d fungsi\\
\end{eulercomment}
\begin{eulerformula}
\[
min(1/(x^2+y^2) 
...
\end{eulerformula}
\begin{eulercomment}
dengan batas 0 sampai dengan 2.
\end{eulercomment}
\begin{eulerprompt}
> plot3d("min(1/(x^2+y^2),3)",r=2,limits=[0,2],>hue,zlim=[0,2]):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-098.png}
\begin{eulercomment}
Plot fungsi dapat dipotong. Hal ini dilakukan dengan vektor "limits"
dan diterapkan pada nilai-z. Ini terlihat lebih baik daripada dataran
tinggi sederhana yang dapat dihasilkan oleh "min(f(x,y),zmax)".
Bingkai akan tetap sesuai dengan data plot, kecuali "zlim" disediakan.

Batasannya berfungsi untuk nilai tertentu. Nilai-nilai tersebut juga
digunakan untuk menghitung level.
...
\end{eulerformula}
\begin{eulerprompt}
>plot3d(("4*y*exp(-x^2-y^2)"),r=2,...
>angle=100°,zoom=3,>contour,color=yellow):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-100.png}
\begin{eulercomment}
Berikut gambar grafik dari fungsi yang diperintahkan. Di sini saya
membuat grafiknya menggunakan perintah plot 3d dan dibuat desain
konturnya.



3. Gambarkan grafik fungsi implisit\\
\end{eulercomment}
\begin{eulerformula}
\[
f(x,y,z)=2x^3y+yz^2-xz^3-1=0
\]
\end{eulerformula}
\begin{eulerprompt}
>plot3d("2*x^3*y+y*z^2-x*z^3",>implicit,r=4,zoom=3,angle=90°,framecolor=red):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-102.png}
\begin{eulercomment}
4. Gambarlah suatu fungsi menggunakan povray!
\end{eulercomment}
\begin{eulerprompt}
>load povray;
>defaultpovray="C:\(\backslash\)Program Files\(\backslash\)POV-Ray\(\backslash\)v3.7\(\backslash\)bin\(\backslash\)pvengine.exe"
...
\end{euleroutput}
\begin{eulerprompt}
>pov3d("2*x^3*y",zoom=3,angle=-110°);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-103.png}
\begin{eulercomment}
Di sini saya menggambarkan fungsi\\
\end{eulercomment}
\begin{eulerformula}
\[
2x^3y
...
\begin{eulerprompt}
>function f(x):=x^3+1;...
>x=-2:0.01:1; t=linspace(0,2pi,10)';...
>Z=x; X=cos(t)*f(x); Y=sin(t)*f(x);...
>pov3d(X,Y,Z,angle=100°,height=10°,axis=0,zoom=3,light=[10,-5,5],background=yellow);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D_Nabila 'Aqil Mufida_22305141039-106.png}
\end{eulernotebook}
